...
//     const [avatarFile, setAvatarFile] = useState(null); // Nayi file ke liye state
//     const [preview, setPreview] = useState(''); // Nayi file ka preview dikhane ke liye
//     const [loading, setLoading] = useState(true);
//     const fileInputRef = useRef(null); // File input ko trigger karne ke liye
...
//     // Jab user nayi file select karta hai
...
//     // Jab user "Upload" button par click karta hai
...
//         e.preventDefault();
//         // ... aapka puraana profile update ka logic ...
//     };
...
//                     className="hidden" // Isko chhupa dein
//                     accept="image/*"
//                 />
//                 <div>
//                     <button 
//                         onClick={() => fileInputRef.current.click()} // Chhupe hue input ko trigger karein
...
//                 {/* ... aapka puraana form (name, email, bio, etc.) ... */}
//                 <div>
//                     <label htmlFor="name">Your Name</label>
//                     <input type="text" name="name" value={formData.name} className="mt-1 block w-full p-2 border rounded-md" />
//                 </div>
//                 {/* ... baaki ke fields ... */}
